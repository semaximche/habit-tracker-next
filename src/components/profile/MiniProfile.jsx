...
const MiniProfile = ({ name, lastOnline, badgeNumber, onFollow, onNavigate, isFollowed }) => {
  ...
  return (
    <div className="flex items-center justify-between my-2 cursor-pointer" onClick={onNavigate}>
